...
import { GrassGarden } from "./grass-garden";
    ...
    <main className="overflow-x-clip bg-[#fff6ed]">
      <section className="relative z-10 min-h-[calc(100svh+1px)]">
        ...
        <Image
          ...
          width={500}
          height={500}
          className="pointer-events-none absolute bottom-28 right-2 z-10 h-auto w-[200px] select-none sm:-bottom-16 sm:right-6 sm:w-[320px] md:-bottom-32 md:right-10 md:w-[500px]"
        />
